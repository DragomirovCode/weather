...
public interface LocationDAO extends CrudDAO<Location, Integer> {
    ...
    Optional<Location> findByLocationLatitudeAndLongitude(BigDecimal latitude, BigDecimal longitude, int userId);
    Optional<Location> findByLocationLatitudeAndLongitudeAndUserId(BigDecimal latitude, BigDecimal longitude, int userId, String name);
}
